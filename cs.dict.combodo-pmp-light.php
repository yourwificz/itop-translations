...
Dict::Add('CS CZ', 'Czech', 'Čeština', array(
	...
	'Class:Project/Attribute:status/Value:cancelled' => 'Zrušeno',
	'Class:Project/Attribute:status/Value:closed' => 'Uzavírání',
	'Class:Project/Attribute:status/Value:executed' => 'Probíhá',
	'Class:Project/Attribute:status/Value:initiated' => 'Zahájení',
	...
	'Menu:ProjectManagement' => 'Správa projektu',
	...
	'UI-ProjectManagementOverview-Last-12Months' => 'Projekty za posledních 12 měsíců (pro každé datum zahájení projektu)',
...
Dict::Add('CS CZ', 'Czech', 'Čeština', array(
	...
	'UI-WBSManagementOverview-OpenWBSByProject' => 'Otevřené dodávky podle projektu zákazníka',
));
